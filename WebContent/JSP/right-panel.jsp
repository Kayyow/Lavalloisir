<div id="rightPanel">
	<div class="columnBox connection">
		...
		<form id="cnctForm">
			<label for="cnctLogin">Identifiant :</label> <input type="text"
				class="cnctInput login" name="login" placeholder="Identifiant">

			<label for="cnctPwd">Mot de passe : </label> <input type="text"
				class="cnctInput pwd" name="password" placeholder="••••••••••••">
			<a href="">S'inscrire</a> <input type="submit" value="Connexion"
				id="cnctButton">
		</form>
	</div>
