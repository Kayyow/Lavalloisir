...
import static com.lavalloisir.beans.dao.DAOUtil.*;
...
public class UserDAOImpl implements UserDAO {
	...
	private static final String SQL_SELECT_BY_LOGIN_PASSWD =
			"";
    ...
    public User find (String login, String password) throws DAOException {
        ...
        try {
        	...
        	preparedStmt = initPreparedStatement(cnct, SQL_SELECT_BY_LOGIN_PASSWD, false, login, password);
        	...
        	silentsClosing(rs, preparedStmt, cnct);
        }
    ...
    public void create (User user) throws IllegalArgumentException, DAOException {
    	...
    	try {
    		// Récupération d'une connexion depuis la Factory
    		cnct = daoFactory.getConnection();
    		preparedStmt = initPreparedStatement(cnct, SQL_INSERT, true, /*CHOSE A REAJOUTER*/ );
    		...
    		silentsClosing(autoGeneratedValues, preparedStmt, cnct);
    	}
    }
